...
const translations = {
    nl: {
        ui: {
            ...
            project_nas_prob_title: "Het Probleem",
            project_nas_prob_desc: "Het handmatig downloaden, hernoemen, sorteren en streamen van media naar verschillende apparaten in huis is tijdrovend. Daarnaast is downloaden via openbare netwerken onveilig en is er een centrale, veilige opslaglocatie nodig.",
            project_nas_sol_title: "De Oplossing",
            project_nas_sol_desc: "Een gedistribueerde media-infrastructuur over twee nodes: een Raspberry Pi 5 (Docker-host & SambaNAS-opslag) en een HP Thin Client (Proxmox hypervisor). De automatiseringstools (Sonarr/Radarr) communiceren direct via API's met de Pi 5.",
            project_nas_lessons_title: "Geleerde Lessen",
            project_nas_lessons_desc: "Configuratie van API-communicatie tussen fysieke servers (Multi-Node), containerverkeer routeren via een VPN-container met kill-switch, en rechtenbeheer (PUID/PGID) bij SMB/NFS-shares.",
        ...
        ui: {
            ...
            project_nas_prob_title: "The Problem",
            project_nas_prob_desc: "Manually downloading, renaming, sorting, and streaming media to various devices is time-consuming. Additionally, public downloading is insecure, requiring a central, secure storage location.",
            project_nas_sol_title: "The Solution",
            project_nas_sol_desc: "A distributed media infrastructure split across two nodes: a Raspberry Pi 5 (Docker host & SambaNAS storage) and an HP Thin Client (Proxmox hypervisor). Automation tools (Sonarr/Radarr) communicate directly via APIs with the Pi 5.",
            project_nas_lessons_title: "Lessons Learned",
            project_nas_lessons_desc: "Configuring API communication between physical servers (Multi-Node), routing container traffic through a VPN container with a kill switch, and permission management (PUID/PGID) on SMB/NFS shares.",
    ...
    de: {
        ui: {
            ...
            project_nas_title: "Automatisierte Medien-Pipeline & SambaNAS",
            project_nas_desc: "Ein zentraler Netzwerkspeicher (NAS) und eine automatisierte Download- und Medien-Pipeline auf einem energieeffizienten Raspberry Pi 5.",
            project_nas_prob_title: "Das Problem",
            project_nas_prob_desc: "Das manuelle Herunterladen, Umbenennen, Sortieren und Streamen von Medien auf verschiedene Geräte ist zeitaufwendig. Zudem ist das Herunterladen über öffentliche Netze unsicher, weshalb ein zentraler, sicherer Speicherort benötigt wird.",
            project_nas_sol_title: "Die Lösung",
            project_nas_sol_desc: "Eine verteilte Medieninfrastruktur auf zwei Nodes: ein Raspberry Pi 5 (Docker-Host & SambaNAS-Speicher) und ein HP Thin Client (Proxmox-Hypervisor). Automatisierungsdienste (Sonarr/Radarr) & Overseerr kommunizieren direkt über APIs mit dem Pi 5.",
            project_nas_lessons_title: "Erkenntnisse",
            project_nas_lessons_desc: "Konfiguration der API-Kommunikation zwischen physischen Servern (Multi-Node), Routing des Container-Verkehrs über einen VPN-Container mit Kill-Switch und Rechteverwaltung (PUID/PGID) für SMB/NFS-Freigaben.",
